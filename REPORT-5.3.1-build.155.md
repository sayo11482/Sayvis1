...
**Release:** [v5.3.1-build.155](https://github.com/sayo11482/Sayvis1/releases/tag/v5.3.1-build.155)
**APK:** [SAYVIS-5.3.1-debug.apk](https://github.com/sayo11482/Sayvis1/releases/download/v5.3.1-build.155/SAYVIS-5.3.1-debug.apk) + [SHA256](https://github.com/sayo11482/Sayvis1/releases/download/v5.3.1-build.155/SAYVIS-5.3.1-debug.apk.sha256)
**ویندوز:** [SAYVIS-5.3.1-windows.zip](https://github.com/sayo11482/Sayvis1/releases/download/v5.3.1-build.155/SAYVIS-5.3.1-windows.zip)
**CI:** completed / success — versionCode 21 / versionName 5.3.1، کامیت `a476d7b` — هر دو تست و بیلد دسکتاپ سبز
**برانچ:** `arena/01a0a110-sayvis1` — فورس‌پوش از `cd96345` به `490af23 → a476d7b` (تمام دارایی v5.3.0 حفظ)
...
- **CI بعد از فیکس:** run `35606317283` — `in_progress → completed success` در ۶ دقیقه (هر دو job `testDebugUnitTest` و `desktop:packageUberJarForCurrentOS` سبز)
...
- تگ: `v5.3.1-build.155` (versionCode 21)
